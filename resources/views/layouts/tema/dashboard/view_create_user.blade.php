                            ...
                            <div id="flStackForm" class="col-lg-12 layout-spacing layout-top-spacing">
                                <div class="statbox widget box box-shadow">
                                    ...
                                    <div class="widget-content widget-content-area">
                                        <form action="{{ url('/admin/users-management-tambah') }}" method="POST">
                                            @csrf
                                            <div class="form-group mb-3">
                                                <input type="name" name="nama" class="form-control" id="sEmail" aria-describedby="emailHelp1" placeholder="Nama" value="{{ old('nama') }}">
                                            </div>
                                            <div class="form-group mb-3">
                                                <input type="email" name="email" class="form-control" id="sEmail" aria-describedby="emailHelp1" placeholder="Email address" value="{{ old('email') }}">
