                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex flex-column align-items-center text-center">
                                                        ...
                                                        <div class="mt-3">
                                                            ...
                                                            <p class="text-secondary mb-1">{{ Auth::user()->kategori_permohonan}}
                                                            </p>
                                                            <p class="text-muted font-size-sm">{{ Auth::user()->noreg}}</p>
                                                            <a href="{{ url('/user/view') }}" class="btn btn-primary">Home</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <h6 class="mb-0">Status Mengirim Permohonan:</h6>
                                                        </div>
                                                        <div class="col-sm-9 text-secondary">
                                                            {{ Auth::user()->status_kirim_permohonan }}
                                                        </div>
                                                    </div>
                                                    <hr>
                                                    <div class="row">
